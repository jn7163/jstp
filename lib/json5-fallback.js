...
json5.parse = (data) => {
  ...
  const parser = new Json5Parser(data);
  return parser.parse();
};
...
// Internal JSON5 parser class
//   string - a string to parse
//
function Json5Parser(string) {
  this.string = string;
...
// Start parsing
//
Json5Parser.prototype.parse = function() {
...
// an error otherwise
//
Json5Parser.prototype.ensureEndOfData = function() {
  this.skipClutter();
...
//
Json5Parser.prototype.lookahead = function() {
...
//
Json5Parser.prototype.advance = function() {
...
//
Json5Parser.prototype.retreat = function() {
  this.lookaheadIndex--;
...
//
Json5Parser.prototype.match = function(token) {
...
//
Json5Parser.prototype.throwError = function(message) {
...
//
Json5Parser.prototype.throwExpected = function(token) {
...
//
Json5Parser.prototype.throwUnexpected = function(token) {
...
//
Json5Parser.prototype.isWhitespace = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isNewline = function(character) {
  return character === '\n' || character === '\r';
};
...
//   character - a character to check
//
Json5Parser.prototype.isLetter = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isInitialDigit = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isDigit = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isBinaryDigit = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isOctalDigit = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isDecimalDigit = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isHexadecimalDigit = function(character) {
  return (character >= '0' && character <= '9') ||
...
//   character - a character to check
//
Json5Parser.prototype.isQuoteCharacter = function(character) {
...
//   character - a character to check
//
Json5Parser.prototype.isInititalIdentifierCharacter = function(character) {
  return (character >= 'a' && character <= 'z') ||
...
//   character - a character to check
//
Json5Parser.prototype.isIdentifierCharacter = function(character) {
...
//
Json5Parser.prototype.skipClutter = function() {
  this.skipWhitespace();
  this.skipComments();
  this.skipWhitespace();
};
...
// Skip whitespace
//
Json5Parser.prototype.skipWhitespace = function() {
...
// Skip comments
//
Json5Parser.prototype.skipComments = function() {
  if (this.lookahead() !== '/') {
    return;
  }
...
//
Json5Parser.prototype.skipLineCommentBody = function() {
...
//
Json5Parser.prototype.skipMultilineCommentBody = function() {
  let done = false;
...
//
Json5Parser.prototype.parseValue = function() {
  this.skipClutter();
...
// Parse a number
//
Json5Parser.prototype.parseNumber = function() {
  this.skipClutter();
...
//
Json5Parser.prototype.parseDecimal = function() {
  let number = '';
...
//     same enitity
//
Json5Parser.prototype.checkNumberPartEncountered =
...
//   base - 2, 8 or 16
//
Json5Parser.prototype.parseMachineInteger = function(base) {
  const self = this;
  const checkers = {
...
//
Json5Parser.prototype.parseIdentifier = function() {
  this.skipClutter();
...
//
Json5Parser.prototype.parseString = function() {
  this.skipClutter();
...
//
Json5Parser.prototype.parseOctalEncodedStringCharacter = function() {
  let digits = '';
...
//
Json5Parser.prototype.parseHexEncodedStringCharacter = function(nibblesCount) {
  let digits = '';
...
//
Json5Parser.prototype.parseOneByteHexEncodedCharacter = function() {
  this.match('x');
...
// and return the corresponding character
//
Json5Parser.prototype.parseTwoByteHexEncodedCharacter = function() {
  this.match('u');
...
//
Json5Parser.prototype.parseUnicodeCharacter = function() {
  this.match('u');
...
// character
//
Json5Parser.prototype.parseEs6UnicodeLiteral = function() {
  this.match('{');
...
// Parse an array
//
Json5Parser.prototype.parseArray = function() {
  this.skipClutter();
  this.match('[');
...
// Parse an object
//
Json5Parser.prototype.parseObject = function() {
  this.skipClutter();
...
//
Json5Parser.prototype.parseObjectKey = function() {
  this.skipClutter();
